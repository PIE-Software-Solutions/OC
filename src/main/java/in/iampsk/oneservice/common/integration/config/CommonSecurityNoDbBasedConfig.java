...
import in.iampsk.oneservice.common.integration.util.EnableSecurityNoDbBasedCondition;
 ...
 * @author Kiran
 */
@Conditional(value = {EnableSecurityNoDbBasedCondition.class})
@EnableAutoConfiguration(exclude={DataSourceAutoConfiguration.class})
@Configuration
@PropertySource("file:${oneservice.home}/${oneservice.prop}.properties")
public class CommonSecurityNoDbBasedConfig extends WebSecurityConfigurerAdapter {

	private final AppLogger LOGGER = new AppLogger(CommonSecurityNoDbBasedConfig.class.getName());
	/**
