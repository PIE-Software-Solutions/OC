...
import com.kj.oneservice.common.integration.config.SwaggerConfig;
import com.kj.oneservice.common.integration.swagger.ExtendedSwaggerProxyRequestMappingHandlerMapping;
...
public class SwaggerConfigTest {
	...
	@Test
	public void testSwaggerApiWithSwaggerHost() {
		SwaggerConfig swaggerConfig = new SwaggerConfig();
		Docket docket = swaggerConfig.swaggerApi("localhost:8081");
		assertNotNull(docket);
	}
